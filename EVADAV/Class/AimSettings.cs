...
namespace EVADAV.Class
{
    internal static class AimSettings
    {
        ...
        public static string ArduinoComPort => GetDropdown("Arduino COM Port");
        public static bool IsArduinoMouse =>
            MouseMovementMethod.IndexOf("Arduino", StringComparison.OrdinalIgnoreCase) >= 0;
